...
\lstset{language=Java, morekeywords={XsdAppInfo, XsdDocumentation, ArrayList, List, XsdIdentifierElements}}
...
%TODO Change this figure to remove the AbstractElementVisitor
