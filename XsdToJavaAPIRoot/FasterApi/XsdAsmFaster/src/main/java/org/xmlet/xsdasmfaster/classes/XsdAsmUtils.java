...
public class XsdAsmUtils {
    ...
    static {
        ...
        xsdFullTypesToJava.put("xsd:anyURI", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xs:anyURI", XsdSupportingStructure.JAVA_STRING_DESC);
        ...
        xsdFullTypesToJava.put("xsd:string", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xs:string", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xsd:normalizedString", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xs:normalizedString", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xsd:token", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xs:token", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xsd:language", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xs:language", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xsd:NMTOKEN", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xs:NMTOKEN", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xsd:Name", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xs:Name", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xsd:NCName", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xs:NCName", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xsd:ID", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xs:ID", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xsd:IDREF", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xs:IDREF", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xsd:ENTITY", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xs:ENTITY", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xsd:untypedAtomic", XsdSupportingStructure.JAVA_STRING_DESC);
        xsdFullTypesToJava.put("xs:untypedAtomic", XsdSupportingStructure.JAVA_STRING_DESC);
    }
    ...
    static boolean isInterfaceMethod(String returnType) {
        return returnType.equals(XsdSupportingStructure.elementTypeDesc);
    }
    ...
    private static String getCleanName(String name, @SuppressWarnings("SameParameterValue") boolean camelCase){
    ...
    static Set<String> getAmbiguousMethods(List<InterfaceInfo> interfaceInfoList) {
        ...
        interfaceMethods.forEach(interfaceMethod -> {
            boolean methodNameAlreadyPresent = dummy.add(interfaceMethod);
