...
public class RegularWithIndentationVisitor<R> implements ElementVisitor<R> {

    private R model;
    private StringBuilder stringBuilder = new StringBuilder();
    private int tabCount = 0;

    public RegularWithIndentationVisitor(){ }

    public RegularWithIndentationVisitor(R model){
        this.model = model;
    }
